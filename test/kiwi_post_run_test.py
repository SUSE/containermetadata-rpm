...
class TestContainerInfoRPM(object):
    def test_get_image_references(self):
        mock_result = Mock()
    ...
    def test_get_image_references_no_tag(self):
        mock_result = Mock()
        mock_result.xml_state.get_container_config.return_value = {
    ...
    def test_get_image_references_no_name(self):
        mock_result = Mock()
        mock_result.xml_state.get_container_config.return_value = {}
        assert get_image_references(
            mock_result, '.', '12.3', '1'
    ...
    def test_get_image_references_additional_tags(self):
        mock_result = Mock()
        mock_result.xml_state.get_container_config.return_value = {
    ...
    def test_get_image_references_no_kiwi_file(self):
        mock_result = Mock()
        mock_result.xml_state.get_container_config.return_value = {}
        exception = False
        try:
    ...
    def test_get_bundled_image_file(self, mock_glob):
    ...
    @patch('containerinfoRPM.kiwi_post_run.glob.glob')
    def test_get_bundled_image_file_fail(self, mock_glob):
        mock_glob.return_value = [
    ...
    @patch('containerinfoRPM.kiwi_post_run.get_bundled_image_file')
    def test_get_image_release_no_release(self, mock_bundled_file):
    ...
    def test_make_spec_from_template(self, mock_dump):
        image_data = dict()
    ...
    def test_main(
        self, mock_load, mock_glob, mock_move, mock_command,
